...
export default function Dashboard({onOpenState}){
  ...
  return <div className="ui-page h-full min-h-0 overflow-hidden">
    ...
    {mode==='situacao'?<div className="h-[calc(100%-46px)] overflow-y-auto pr-1"><SituationRoom/></div>:<div className="grid h-[calc(100%-46px)] min-h-0 grid-rows-[auto_1fr] gap-3">
      ...
      <section className="grid min-h-0 gap-3 xl:grid-cols-[1.05fr_.82fr_.83fr]">
