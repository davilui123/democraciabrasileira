...
export default function Institutions({initialTab='stf'}){
  const {stf,instituicoes=[],candidatosSTF=[],indicarMinistroSTF,votarIndicacaoSTF,oposicao,congresso,institucional,economia}=useGameStore();
